        ...
        if(line_chart_element) {
            ...
            var line_chart = c3.generate({
                ...
                axis: {
                    x: {
                        type: 'category',
                        categories: ['Jan 18', 'Feb 18', 'March 18', 'Apr 18', 'May 18', 'June 18', 'July 18', 'Aug 18', 'Sept 18']
                    }
                },
                data: {
                    columns: [
                        ['FD', 30, 200, 100, 400, 150, 250],
                        ['RD', 50, 20, 10, 300, 15, 25,900,80,50,10,40],
                        ['MIS', 200, 29, 95, 30, 19, 20,800],
                        ['DD', 90, 30, 15, 80, 20, 20,100,20],
                    ],
                    type: 'spline'
                },
                grid: {
