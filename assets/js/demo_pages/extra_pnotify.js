        ...
        $('#pnotify-multiline').on('click', function () {
            ...
            var notice = new PNotify({
                ...
                confirm: {
                    ...
                    prompt_default: 'Write some note',
                    buttons: [
                        {
                            text: 'Save',
                            addClass: 'btn btn-sm btn-primary',
            ...
            notice.get().on('pnotify.confirm', function(e, notice, val) {
                ...
                console.log(ntitle, noteDescription);
                if (ntitle == "")
                {
                    $('#divnoteTitle').html("Title field is required");
                    return false;
                } else
                    $('#divnoteTitle').html("");
                if (noteDescription == "")
                {
                    $('#divnoteDescription').html("Title field is required");
                    return false;
                } else
                    $('#divnoteDescription').html("");



                $.ajax({
                    type: "POST",
                    url: base_url+"/master/quick_note",

                    data: {noteTitle: ntitle, desc: noteDescription},
