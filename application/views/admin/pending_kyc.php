		...
		<div class="card">
			<div class="card-header header-elements-inline">
				...
				<div class="header-elements">
					<b><span style="color:red">*</span> Pending Kyc Approvals</b>
				</div>
			</div>
			<div>
				<table class="table datatable-calcun">
					...
					<tr role="row">
						...
						<th>User ID</th>
						<th>Name</th>
						<th>Unapproved documents numbers</th>
						<th>Unapproved documents name</th>
						<th>View</th>
					</tr>
					</thead>
					<tbody>
					...
					?>
						<tr><td>No Approvals Pending</td></tr>
					<?php } ?>
					</tbody>
				</table>
			</div>
