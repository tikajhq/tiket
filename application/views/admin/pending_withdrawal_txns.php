	...
	<div class="row">
		<div class="card">
			<div class="card-header header-elements-inline">
				<h5 class="font-weight-semibold"><i class="icon-file-text2 mr-2"></i>Pending Withdrawal Request</h5>
                <a class="badge badge-primary p-2" href="<?= base_url('admin/all_withdrawal_requests')?>">Pending Withdrawal Requests</a>
			</div>
			<div>
...
<!--							<th>Sr.</th>-->
					...
					<script type="application/javascript">
						var path = "<?= base_url()?>tabler/txn_requests?type=5&status=70";
						var options = {
							datatable: {
								"ajax": {
									"type": 'POST',
